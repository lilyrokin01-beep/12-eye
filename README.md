...
A CUDA-accelerated seed finder that searches for rare end portals with 10, 11, or 12 pre-filled eyes in Minecraft Java Edition (1.19.3+). Achieves speeds of 10+ billion seeds per second on consumer GPUs.

✨ Features
🚀 Blazing fast – 10-22 Gsps on RTX 3080/4070

👁️ Multiple eye counts – Finds 10, 11, and 12 eye portals
...
💾 Saves results – Automatically writes seeds to 10eyes.txt, 11eyes.txt, 12eyes.txt
...
🧠 How It Works
CPU Stage: Generates possible stronghold layouts using the cubiomes library

GPU Stage: CUDA kernels apply the skip optimization to count portal eyes

Eye Counting: Each chunk of the portal is evaluated independently – detects chunk-boundary portals

Output: Seeds meeting the eye count threshold are printed and saved
...
🙏 Credits
This project is based on the original work by Gaider10.

Original Repository
Gaider10/12-eye

Dependencies
cubiomes – Minecraft biome and structure generation library (MIT License)

CUDA Toolkit – GPU acceleration (NVIDIA)

Modifications Made
Added support for 10- and 11-eye seeds
